...
class AuthProcessor {
  ...
  setNextProcessor(processor) {
    ...
    return processor; // Повертає переданий обробник, щоб дозволити подальше ланцюжкове викликання.
  }
  ...
  validate(username, passkey) {
    ...
    return false; // Якщо наступного обробника немає, повертає false, сигналізуючи про невдалу аутентифікацію.
  }
}
...
class TwoStepProcessor extends AuthProcessor {
  ...
  isValidTwoStepCode() {
    return true; // Завжди повертає true для спрощення прикладу
  }
}
